...
def add_obsticle():
    obsticle_x = round(random.randrange(screen_border, screen_width-screen_border) / 20.0) * 20.0
    obsticle_y = round(random.randrange(screen_border, screen_height-screen_border) / 20.0) * 20.0
